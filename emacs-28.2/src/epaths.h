...
*/
#define PATH_LOADSEARCH "/usr/local/share/emacs/28.2/lisp"

/* Like PATH_LOADSEARCH, but contains the relative path from the
   installation directory.
*/
#define PATH_REL_LOADSEARCH "28.2/lisp"
...
*/
#define PATH_SITELOADSEARCH "/usr/local/share/emacs/28.2/site-lisp:/usr/local/share/emacs/site-lisp"
...
*/
#define PATH_DUMPLOADSEARCH "/scratch/willmacs/emacs-28.2/lisp"
...
#define PATH_EXEC "/usr/local/libexec/emacs/28.2/x86_64-pc-linux-gnu"

/* Where Emacs should look for its architecture-independent data
   files, like the NEWS file.  The lisp variable data-directory
   is set to this value.  */
#define PATH_DATA "/usr/local/share/emacs/28.2/etc"
...
#define PATH_DOC "/usr/local/share/emacs/28.2/etc"
